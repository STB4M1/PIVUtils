...
img1 = read_img_gray_float64("./00_images/square_particles_frame1.png")
img2 = read_img_gray_float64("./00_images/square_particles_frame2.png")

# === PIV 実行 ===
println("PIV begin.")
@time vec_dx, vec_dy, vec_R = PIV_cpu(img1, img2;
        interro_win_w = 64,
        interro_win_h = 64,
        search_factor = 2)
println("PIV end.")
...
savefig(p, "piv_vectors_only_cpu.png")

# ====== PIV ベクトルを .dat 保存 ======

open("piv_vector_field_cpu.dat", "w") do io
